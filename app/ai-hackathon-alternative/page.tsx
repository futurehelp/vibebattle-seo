...
export const metadata: Metadata = {
  title: "AI Hackathon Alternative | Vibebattle",
  description: "AI Hackathon Alternative explained with live builder competition context.",
  alternates: {
    canonical: "https://vibebattle.space/ai-hackathon-alternative",
  },
};
